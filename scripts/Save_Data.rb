...
module Save_Data
  ...
  def save()
    ...
    save_data["sell_weapon"] = $player.sell_weapon       # 売却した武器
    save_data["sell_armor"] = $player.sell_armor         # 売却した防具
  ...
  def load()
    ...
    if File.exist?("save_data.dat") then
      ...
      $player.sell_weapon = save_data["sell_weapon"]         # 売却した武器
      $player.sell_armor = save_data["sell_armor"]           # 売却した防具
    end
