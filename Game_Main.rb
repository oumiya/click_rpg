...
require_relative './scripts/Active_Skills.rb'
require_relative './scripts/Armor_Data.rb'
require_relative './scripts/Enemy_Data.rb'
require_relative './scripts/Hair.rb'
require_relative './scripts/Hair_Item.rb'
require_relative './scripts/Player.rb'
require_relative './scripts/Save_Data.rb'
require_relative './scripts/Scene_Battle.rb'
require_relative './scripts/Scene_Ending.rb'
require_relative './scripts/Scene_Event.rb'
require_relative './scripts/Scene_Equip.rb'
require_relative './scripts/Scene_Home.rb'
require_relative './scripts/Scene_Key_Config.rb'
require_relative './scripts/Scene_Shop.rb'
require_relative './scripts/Weapon_Data.rb'
include Save_Data
